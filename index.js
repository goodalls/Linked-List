...
// $('#katies-button').on('click', function() {
//   //second, append new cards onto the section .bookmark-wrap using jquery
//   var websiteTitle = 'YOUR TITLE HERE';
  
//   $('#bookmark-wrap').append('<div class = "bookmark"><h4>' + websiteTitle + '</h4><hr><a href="http://www.thewebsiteurl.com">www.thewebsiteurl.com</a><hr><label for = "read-button" hidden></label><button class = "bookmark-button" id = "read-button">Read</button><label for = "delete-bookmark-button" hidden></label><button class = "bookmark-button" id = "delete-bookmark-button">Delete</button></div>');
// });
